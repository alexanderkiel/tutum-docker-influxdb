...
Graphite Support
-----------
If you provide a `GRAPHITE_DB`, influx will open a TCP port (2003 or if provided `GRAPHITE_PORT`) for reception of events for the named database.

```docker run -d -p 8083:8083 -p 8086:8086 --expose 8090 --expose 8099 --expose 2003 -e GRAPHITE_DB="my_db" tutum/influxdb```
